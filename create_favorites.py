...
REMOVE_CHANNELS = [
    'Репортер 73', 'Рифей-ТВ', 'Сургут 24', '31 канал (Челябинск)',
    '41 Регион', '12 канал HD (Омск)', 'Норд ТВ (Новодвинск)', '6 ТВ',
    '12 канал Череповец', '7 канал Красноярск', '8 канал (Владивосток)',
    '8 канал (Красноярский край)', '8 канал (Новосибирск)', 'TMTV',
    'UGRA TRAVEL', 'АИСТ HD', 'Амурское областное телевидение',
    'Ариг Ус 24 HD', 'Арктика 24', '78 канал', 'Первый Севастопольский',
    'НТС (Севастополь)', 'СТВ (Севастополь)', 'ТРК-555', 'Крым 1', 'Крым 24',
    'Арктик-ТВ HD', 'Архыз-24 HD', 'Астрахань 24 HD', 'АТВ-Медиа',
    'АТВ-Ставрополь', 'СТВ 24 (Северодвинск)', 'Барс плюс', 'Башкортостан 24',
    'Белгород 24', 'Брянская Губерния HD', 'БСТ', 'Вариант V', 'Вектор 24',
    'Ветта 24 Пермь', 'Волга', 'Волгоград 1', 'Волгоград-24 HD', 'ВОТтв HD',
    'Время Н', 'Всё ТВ', 'ВТК 41 "Аргус"', 'Городской телеканал Ярославль',
    'Губерния 33 HD', 'Губерния Самара', 'Девятка ТВ', 'Дзержинск ТВ',
    'ДОН 24 HD', 'Евразия', 'Енисей HD', 'Ивановское общественное телевидение',
    'Импульс Севера', 'Инфо 24 (Шадринск)', 'Информационная служба Югры',
    'Кавказ 24', 'Камчатка HD', 'Каскад', 'Катунь 24', 'Краснодар HD',
    'КТВ-Город', 'Кузбасс 1', 'Липецкое время', 'Майдан',
    'Майкопское Телевидение', 'Матур ТВ', 'МИГ ТВ', 'Мир Белогорья',
    'Мордовия 24', 'Муравленко 24', 'Народное телевидение Мордовии',
    'Национальное ТВ Чувашии', 'Наш дом', 'Север (Нарьян-Мар)',
    'Котлас ТВ (Арх. область)', 'Санкт-Петербург', 'Москва 24',
    'Москва. Доверие', 'Наши города', 'НВК (Саха)', 'Ника-ТВ', 'ННТВ',
    'Новое время (Радужный)', 'Новый век (Тамбов)', 'НСК 49', 'НТС Иркутск',
    'НТС-Ирбит (Екатеринбург)', 'Область 45 HD', 'Объектив 59 HD',
    'ОРТ-Планета (Оренбург)', 'Осетия Ирыстон HD', 'ОТВ Екатеринбург HD',
    'ОТВ-Владивосток', 'ОТВ-Сахалин', 'ОТВ Челябинск', 'ОТС HD',
    'Первый городской (Киров)', 'Первый областной (Орёл)',
    'Первый Тульский HD', 'Первый Ярославский', 'Прима-ТВ',
    'РГВК Дагестан', 'Регион 29', 'РТС-Абакан', 'Русский Север',
    'Русь (Кострома)', 'Рыбинск-40', 'С1 Сургут HD', 'Самара-24',
    'Самара-Гис', 'Сампо ТВ 360°', 'Саратов-24', 'Саха',
    'Мамонт (Республика Саха - Якутск)', 'Своё ТВ Ставрополь HD',
    'ТВ-7 Абакан', 'ТВ21+', 'Татарстан 24', 'Сочи24 HD', 'СТВ-Байкал',
    'ТВ-Губерния', 'ТВ-ИН-Магнитогорск', 'ТВ-Колыма-Плюс HD',
    'Тивиком HD', 'ТК Центр Красноярск', 'ТКР Рязань', 'ТНВ-Планета',
    'ТНВ-Татарстан', 'ТНР 24 (Нижневартовск)', 'Толк', 'Толпар ТВ',
    'Тольятти-24', 'Томское время HD', 'Тюменское время', 'Удмуртия',
    'Ульяновская правда', 'Хамдан', 'Эфир', 'Югорск ТВ', 'Югра', 'Шаян ТВ',
    'Экспресс HD', 'Юрган', 'ЮТВ Чебоксары', 'Якутия 24', 'Ямал-Регион', '5 Канал HD',
]
